...
if __name__ == '__main__':
    ...
    for interaction_range in [interaction_range]:
        for J in [1.]:
            H = spin_system.get_XY_Hamiltonian(2 * J, [], Jij=interaction_matrix)
            ...
            print(min_variance_SN_t)
            print(argrelextrema(min_variance_SN_t, np.less))
            ...
            util.store_observed_t(results_t, 'observables_vs_t_coarse_{}_{}_N_{}_{}_J_{}'.format(method, structure, spin_system.N, interaction_shape, J))