...
if __name__ == '__main__':
    ...
    for interaction_range in interaction_range_list:
        ...
        for h in spin_system.N * Jz * np.array(sorted([-0.5, -0.25, -0.1, -0.], reverse=True)):
            ham_terms = ['Sz_sq', 'S_x']
            strengths = [Jz, h]
            ...
            plt.savefig('TFI_symm_wigner/variance_SN_vs_t_N_{}_{}_{}_{}_Jz_{}_h_{}.png'.format(spin_system.N, interaction_shape, interaction_param_name, interaction_range, Jz, h))
            plt.close()
            ...
            for t_cur, psi in zip(t_select, psi_select):
                ...
                filename = 'TFI_symm_wigner/wigner_N_{}_{}_{}_{}_Jz_{}_h_{}_t_{}.png'.format(spin_system.N, interaction_shape, interaction_param_name, interaction_range, Jz, h, t_cur)
            ...
            with imageio.get_writer('TFI_symm_wigner/wigner_N_{}_{}_{}_{}_Jz_{}_h_{}.gif'.format(spin_system.N, interaction_shape, interaction_param_name, interaction_range, Jz, h), mode='I') as writer:
