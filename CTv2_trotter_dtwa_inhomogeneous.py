...
if __name__ == '__main__':
    ...
    for interaction_range in [interaction_range]:
        for J in [1.]:
            H_1 = spin_system.get_Ising_Hamiltonian(2 * J, [], Jij=interaction_matrix)
            H_2 = spin_system.get_Ising_Hamiltonian(J, [], Jij=interaction_matrix)
            spin_evolution = sd.SpinEvolution((H_1, H_2), psi_0, B=B)

            cont_filename = 'observables_vs_t_{}_{}_N_{}_{}_J_{}'.format(method, structure, N, interaction_shape, J)
