...
if __name__ == '__main__':
    ...
    for interaction_range in interaction_range_list:
            ...
            for steps in step_list:
                ...
                total_T = t[-1] / 3.
                variance_SN_vs_delta_t_vs_N[N][(1., total_T / steps)] = variance_SN_t[-1]

            util.plot_variance_SN_vs_t_trotter(variance_SN_t_vs_steps, t_vs_steps, total_T, method, N, interaction_shape, interaction_param_name, interaction_range, dirname=dirname + '/plots')
            util.plot_variance_norm_vs_t_trotter(variance_norm_t_vs_steps, t_vs_steps, total_T, method, N, interaction_shape, interaction_param_name, interaction_range, dirname=dirname + '/plots')
            
            util.plot_components_vs_t_trotter(components_vs_steps, t_vs_steps, total_T, method, N, interaction_shape, interaction_param_name, interaction_range, dirname=dirname + '/plots')
            util.plot_signal_noise_vs_t_trotter(components_vs_steps, variance_norm_t_vs_steps, t_vs_steps, total_T, method, N, interaction_shape, interaction_param_name, interaction_range, dirname=dirname + '/plots')
            
    # util.plot_variance_SN_vs_delta_t_trotter(variance_SN_vs_delta_t_vs_N, method, interaction_shape, interaction_param_name, interaction_range, dirname=dirname + '/plots')
